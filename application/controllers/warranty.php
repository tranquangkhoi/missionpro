...
class Warranty extends CI_Controller {
	public function __construct(){
		parent::__construct();
		$this->load->model('home/warranty_model');
	...
	public function index(){		
		...
		$intro = $this->warranty_model->get_intro_id($slug, $intro_block);				
		...
		//get help data
		$help_data['chat'] = $this->warranty_model->get_chat();
		$help_data['hotline'] = $this->warranty_model->get_hotline();		
		...
		//get home banner
		$data['banner_intro'] = $this->warranty_model->get_banner(1);	
		...
		$this->load->view('home/warranty/warranty_view',$data);
