...
class Security extends CI_Controller {
	public function __construct(){
		parent::__construct();
		$this->load->model('home/security_model');
	...
	public function index(){		
		...
		$intro = $this->security_model->get_intro_id($slug, $intro_block);				
		...
		//get help data
		$help_data['chat'] = $this->security_model->get_chat();
		$help_data['hotline'] = $this->security_model->get_hotline();		
		...
		//get home banner
		$data['banner_intro'] = $this->security_model->get_banner(1);	
