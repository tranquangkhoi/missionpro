...
<div id="menu-mobile-display"  class="menu-mobile hidden-lg-up">
  <div class="content-menu" style="max-height:100%">
    <div class="title-menu-mobile"> <a href="/">Thỏ Ngọc Shop</a>
    ...
    <div class="ft-menu-mobile">
      <ul>
        <li><span>Hotline
          ...
          </span><img src="<?php echo base_url();?>public/home/images/phone-menu-mobile.png" alt="Gọi ngay"/></li>
      </ul>
    </div>
  </div>
...
<header>
  <section class=" header-banner hidden-sm-down"> <a href="#" title="#">
    <div class="banner_top" style="background-image: url('<?php echo base_url();?>public/home/images/banner_top.png?1488253630693');"></div>
    </a> </section>
    ...
    <div class="container container_main">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-8 col-sm-6 col-xs-6 logo_mx991">
          <div class="logo"> <a href="<?php echo base_url();?>" title="Thỏ ngọc shop"> <img src="<?php echo base_url();?>public/home/images/logo.png" alt="Thỏ ngọc shop"> </a> </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-md-down search-item">
          <div class="support_search hidden-md-down">
            <h5>Hotline : </h5>
            <span> <?php echo $company->company_hotline;?></span> </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-3 hidden-xs account-cart">
          ...
          <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 cart cart_mx991">
            <div class="top-cart-contain">
              <div class="mini-cart shopping-cart">
                <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> <a>
                  <div>
                  <a href="<?php echo base_url().'giohang.html'?>"><img class="mg_bt_10" src="<?php echo base_url();?>public/home/images/cart.png" alt="Giỏ hàng" width="30" height="30" /></a> </div>
                  <div class="cart-box">
                    <span class="title cl_old hidden-sm-down">Giỏ hàng</span>
                    <span id="cart-total" class="cartCount"></span> </div>
                  </a>
                  </div>
  ...
  <div class="container">
    <div class="row nav_menu">
      ...
      <div class="col-lg-4 col-md-8 hidden-sm-down social pull-right hidden-xs ">
        <div class="social-icon"><a href="#" title ="Theo dõi Thỏ ngọc shop trên Printerest"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></div>
        <div class="social-icon"><a href="#" title ="Theo dõi Thỏ ngọc shop trên Youtube"><i class="fa fa-youtube" aria-hidden="true"></i></a></div>
        <div class="social-icon"><a href="#" title ="Theo dõi Thỏ ngọc shop trên Google Plus"><i class="fa fa-google-plus" aria-hidden="true"></i></a></div>
        <div class="social-icon"><a href="#" title ="Theo dõi Thỏ ngọc shop trên Twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></div>
        <div class="social-icon"><a href="#" title ="Theo dõi Thỏ ngọc shop trên Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></div>
      </div>
    </div>
  </div>
</nav>