...
class Session
{
     ...
     */
     private function initialize($config)
     {
        ...
        if (isset($_SESSION[$this->sess_namespace]) ) {
            $this->userdata = $_SESSION[$this->sess_namespace];
            if (! $this->is_expired()) {
                return;
            }
        }
    ...
    {        
		if ( ! isset($this->userdata['expire_at'])) {
            return TRUE;
        }
        return (time() > $this->userdata['expire_at']);
    }
    ...
    public function set_userdata($data = array(), $value = '')
    {
        ...
        $_SESSION[$this->sess_namespace] = $this->userdata;
    }
