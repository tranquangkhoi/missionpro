                    ...
                    <tbody>
						...
						<tr>
                            ...
                            <td class="image" align="center">
                        		<a href="<?php echo $dlink;?>"><img width="60" src="<?php echo $img;?>" alt="<?php echo $item['product_name'];?>" title="<?php echo $item['product_name'];?>"></a>
                          	</td>
                        	<td class="name">
                            	<a href="<?php echo $dlink;?>"><?php echo $item['product_name'];?></a>                                      
                          	</td>
                        	<td class="price"><?php echo number_format($item['product_price'],0);?> đ</td>
                            <td class="quantity" style="text-align:center;">
                                <?php echo $item['product_quantity'];?> 
                            </td>                        
                        	<td class="total"><?php echo number_format($thanhtien,0);?> đ</td>                            
                      	</tr>
                        <?php
						}
						?>
                        ...
                        <td align="center"  class="tong"><?php echo number_format($tongso,0);?></td>
                        <td align="center"  class="tong"><?php echo number_format($tongtien,0);?> đ</td>                        
                      </tr>
					</tbody>
                  </table>
		</div>
