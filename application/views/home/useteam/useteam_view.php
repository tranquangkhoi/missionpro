    ...
    <div class="mnuColLeft">
    	<ul>
			...
			<?php			 	  			 
			  ...
			  ?>
        		<li><a href="<?php echo base_url().$this->config->item('index_page_add').$this->uri->segment(1);?>/<?php echo $item['intro_slug'].'.html';?>"><?php echo $item['intro_title'];?></a></li>
            <?php
			}
			?>
        </ul>
...
<div class="path">
	...
	?>
	<a class="clor3" href="<?php echo base_url().$this->config->item('index_page_add');?>">Trang chủ</a> &gt; <a class="clor3" href="<?php echo base_url().$this->config->item('index_page_add');?>helpcenter.html">
    <strong><?php echo $block_arr[$intro_block]; ?></strong></a>
     </div>
	<div class="padT15">
