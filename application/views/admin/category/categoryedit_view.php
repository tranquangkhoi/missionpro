         ...
         <div class="panel-body">
            <form name="frm_categoryadd" id="frm_categoryadd" enctype="multipart/form-data" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/<?php echo $this->uri->segment(3);?>/<?php echo $f_category['category_id'];?>' method="POST" role="form" style="display:inline">
               ...
               <div class="row">
                 <div class="col-md-6  col-md-offset-3">
                    <?php
                       if($f_category['image_old']<>''){
                        ?>
                    <div id="deleteimg" class="control-group">
                       <label class="control-label" for="input01">Ảnh cũ</label>
                       <div class="controls">
                          <img class="img-thumbnail" src="<?php echo base_url();?>/public/upload/category/<?php echo 'small_'.$f_category['image_old'];?>" />
                          <a class="btn btn-danger delete" href="<?php echo base_url().$this->config->item('index_page_add').'admin/'.$this->uri->segment(2);?>/delimg/<?php echo $f_category['category_id'];?>">
               ...
               <div class="row">
                  <div class="col-md-6  col-md-offset-3">
                     <div class="form-group">
                        <label for="category_id" class="control-label">Icon:</label>
               ...
               <input name="image_old" type="hidden" id="image_old" value="<?php echo $f_category['image_old'];?>" />
