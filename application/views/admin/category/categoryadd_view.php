   ...
   <div id="main" class="container">
      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            <form name="frm_categoryadd" id="frm_categoryadd" enctype="multipart/form-data" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/<?php echo $this->uri->segment(3);?>' method="POST" role="form" style="display:inline">
               <?php if(!empty($msg)){?>
