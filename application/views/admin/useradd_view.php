       	...
       	<div class="row">  			
			<div class="col-md-12">
				<div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
					<a class="btn btn-primary" href="javascript:frm_submit('frmAddUser');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
		...
		<div class="panel panel-default">          
			<div class="panel-heading"><strong style="font-size:16px;">Thêm mới</strong></div>
				<div class="panel-body">
                	<form name="frmAddUser" id="frmAddUser" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/<?php echo $this->uri->segment(3);?>' method="POST" role="form">
					<?php if(!empty($msg)){?>
