     ...
     <div id="breadcrumb" class="container" style="padding-top:70px;">
      ...
      <div id="main" class="container">
       ...
       <?php 
		...
		?>
       <form id="frm_contacts" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/del' method="POST" style="display:inline;">
        <div class="row">
  			<div class="col-md-4">
            	 <div class="input-group" style="margin-bottom:10px; margin-top:-10px;">
					<input  class="form-control noEnterSubmit" name="q" type="text"  placeholder="Nhập thông tin cần tìm..." >                          
                          <span style="cursor:pointer;" class="input-group-addon" onclick="frm_submit_action('frm_contacts','<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/filter')" >
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr style="background-color:#BFB;">
                  ...
                  <th width="44%"><strong>Tiêu đề thư</strong></th>
                  <th width="30%"><strong>Ngày gửi</strong></th>                   
			  ...
			  ?>  
                <tr>
                    <td style="text-align:center;"><input type="checkbox"  class="check_one" name="check_del[]" value="<?php echo $item['contact_id'];?>"></td>
                    <td style="text-align:center;"><?php echo $stt;?></td>
                    <td><?php echo $item['contact_subject'];?></td>
                    <td><?php echo $this->back->fix_date('H:i:s A, d/m/Y',$item['contact_date']);?></td>                                       
                    <td style="text-align:center;">
                     <a href="<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/view/<?php echo $item['contact_id'];?>">Xem chi tiết</a>                                          
                    </td>
                </tr>
              <?php
			  }
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" onclick="frm_submit('frm_contacts')">Xóa</button> 
