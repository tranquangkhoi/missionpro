    ...
    <div id="wrap">
      ...
      <div id="main" class="container">
       ...
       <?php 
		...
		?>
       <form id="frm_autocodes" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/del' method="POST" style="display:inline;">
       ...
       <div class="row">        	
  			<div class="col-md-5">            	 
                 <div class="input-group" style="margin-bottom:10px; margin-top:-10px;">
                          ...
                          <span style="cursor:pointer;" class="input-group-addon" onclick="frm_submit_action('frm_autocodes','<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/filter')" >
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr style="background-color:#BFB;">
                  <th width="10%" style="text-align:center;"><input type="checkbox" class="check_all"></th>
                  <th width="10%" style="text-align:center;"><strong>STT</strong></th>                  
                  <th width="10%"><strong>Mã code</strong></th>
                  <th width="55%"><strong>Mô tả</strong></th>                   
                  <th width="15%" style="text-align:center;"><strong>Chức năng</strong></th>                
                </tr>
              </thead>
              <tbody>             
              <?php			  
			  foreach($autocode_items as $item){
				  $stt = $stt + 1;				
			  ?>  
                <tr>
                    <td style="text-align:center;"><input type="checkbox"  class="check_one" name="check_del[]" value="<?php echo $item['autocode_id'];?>"></td>
                    <td style="text-align:center;"><?php echo $stt;?></td>
                    <td><?php echo $item['autocode_code'];?></td>
                    <td><?php echo $item['autocode_review'];?></td>                                       
                    <td style="text-align:center;">
                     <a href="<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $item['autocode_id'];?>"><span class="glyphicon glyphicon-pencil"></span></a>                                          
                    </td>
                </tr>
              <?php
			  }
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" onclick="frm_submit('frm_autocodes')">Xóa</button> 
