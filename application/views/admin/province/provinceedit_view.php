    ...
    <div id="wrap">
      ...
      <div id="main" class="container">
      		<div class="row">  			
                <div class="col-md-12">
                    <div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
                        <a class="btn btn-primary" href="javascript:frm_submit('provinceedit');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
			...
			<div class="panel-heading"><strong style="font-size:16px;">Cập nhật danh mục</strong></div>
			<div class="panel-body">            	
                <form name="provinceedit" id="provinceedit" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $f_province['province_id'];?>' method="POST">
				<?php if(!empty($msg)){?>
               ...
               <div class="row">
                ...
                <input name="id" type="hidden" id="id" value="<?php echo $f_province['province_id'];?>" />                              
                </form>
          	</div>
        </div>
