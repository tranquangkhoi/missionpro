    ...
    <div id="wrap">
      ...
      <div id="breadcrumb" class="container" style="padding-top:70px;">
          <ol class="breadcrumb">
            ...
            <li class="active">
              <a href="#">Cập nhật danh mục Banner</a>
            </li>
          </ol>
      </div>      
      <!-- End Path -->
      ...
      <div id="main" class="container">
      		<div class="row">  			
                <div class="col-md-12">
                    <div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
                        <a class="btn btn-primary" href="javascript:frm_submit('bannercateedit');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
			...
			<div class="panel-body">            	
                <form name="bannercateedit" id="bannercateedit" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $f_bannercate['bannercate_id'];?>' method="POST" role="form">
				<?php if(!empty($msg)){?>
                ...
                <input name="id" type="hidden" id="id" value="<?php echo $f_bannercate['bannercate_id'];?>" />
                </form>
          	</div>
        </div>
      </div>
