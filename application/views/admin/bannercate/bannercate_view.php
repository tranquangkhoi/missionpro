    ...
    <div id="wrap">
      ...
      <div id="main" class="container">
       ...
       <?php 
			...
			?>
         <form id="frm_bannercate" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/del' method="POST" style="display:inline;">
  			...
  			<div class="col-md-4">
            	 <div class="input-group" style="margin-bottom:10px; margin-top:-10px;">
					<input  class="form-control noEnterSubmit" name="q" type="text"  placeholder="Nhập thông tin cần tìm..." >                          
                          <span style="cursor:pointer;" class="input-group-addon" onclick="frm_submit_action('frm_bannercate','<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/filter')" >
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr style="background-color:#BFB;">
                  ...
                  <th width="60%"><strong>Tên danh mục Banner</strong></th>                 
              ...
              <tbody>              
              <?php			  
			  foreach($bannercate_items as $item){
				  $stt = $stt + 1;				
			  ?>  
                <tr>
                    <td style="text-align:center;"><input type="checkbox"  class="check_one" name="check_del[]" value="<?php echo $item['bannercate_id'];?>"></td>
                    <td style="text-align:center;"><?php echo $stt;?></td>
                    <td><?php echo $item['bannercate_name'].' (code:'.$item['bannercate_block'].')';?></td>                   
                  	<td style="text-align:center;">
                    	<a href="<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/sortup/<?php echo $item['bannercate_id'];?>/<?php echo $current_page;?>"><span class="glyphicon glyphicon-arrow-up"></span></a>
                        <a href="<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/sortdown/<?php echo $item['bannercate_id'];?>/<?php echo $current_page;?>"><span class="glyphicon glyphicon-arrow-down"></span></a>
                    </td>                   
                    <td style="text-align:center;">
                     <a href="<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $item['bannercate_id'];?>"><span class="glyphicon glyphicon-pencil"></span></a>                                          
                    </td>
                </tr>
              <?php
			  }
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" onclick="frm_submit('frm_bannercate')">Xóa</button> 
