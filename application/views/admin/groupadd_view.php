    ...
    <div id="wrap">
      ...
      <div id="breadcrumb"  class="container" style="padding-top:70px;">
          <ul class="breadcrumb">
            ...
            <li class="active">
              <a href="#">Thêm nhóm quyền quản trị</a>
            </li>
          </ul>
      </div>      
      <!-- End Path -->
      ...
      <div id="main" class="container">      
           ...
           <div class="panel panel-default">          
			...
			<div class="panel-body">
            	<form name="groupadd" id="groupadd" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/add' method="POST">        
