    ...
    <div id="wrap">
      ...
      <div id="breadcrumb" class="container" style="padding-top:70px;">
          <ul class="breadcrumb">
            ...
            <li class="active">
              <a href="#">Thêm thông tin Module</a>
            </li>
          </ul>
      </div>      
      <!-- End Path -->
      ...
      <div id="main" class="container">
        	<div class="row">  			
                <div class="col-md-12">
                    <div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
                        <a class="btn btn-primary" href="javascript:frm_submit('frm_frameadd');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
			...
			<div class="panel-heading"><strong style="font-size:16px;">Thêm mới thông tin</strong></div>
			<div class="panel-body">
            	<form name="frm_frameadd" id="frm_frameadd" enctype="multipart/form-data" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/<?php echo $this->uri->segment(3);?>' method="POST" role="form" style="display:inline">        
				<?php if(!empty($msg)){?>
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">                            	
						<select name="frame_code" id="frame_code" class="form-control">
							<?php echo $f_frame['frame_choose'];?>
						</select>
					</div>
				</div>
