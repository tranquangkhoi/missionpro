    ...
    <div id="wrap">
      ...
      <div id="breadcrumb" class="container" style="padding-top:70px;">
          <ol class="breadcrumb">
            ...
            <li class="active">
              <a href="#">Thêm thông tin hỗ trợ trực tuyến</a>
            </li>
          </ol>
      </div>      
      <!-- End Path -->
      ...
      <div id="main" class="container">
			<div class="row">  			
				<div class="col-md-12">
                    <div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
                        <a class="btn btn-primary" href="javascript:frm_submit('frm_configadd');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
			...
			<div class="panel-heading"><strong style="font-size:16px;">Thêm mới nick config hỗ trợ trực tuyến (Yahoo / Skype)</strong></div>
			<div class="panel-body">            	
                <form class="form-horizontal"  name="frm_configadd" id="frm_configadd" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/<?php echo $this->uri->segment(3);?>' method="POST" role="form" >				
				<?php if(!empty($msg)){?>
                ...
                <div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" id="company_email" name="company_fax" value="<?php echo $f_config['company_email'];?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-md-6">
						<input type="email" class="form-control" id="config_address_footer" name="config_address_footer" value="<?php echo $f_config['config_address_footer'];?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-md-6">
						<input type="email" class="form-control" id="config_smtp_user" name="config_smtp_user" value="<?php echo $f_config['config_smtp_user'];?>">
					</div>
				</div>
                <div class="form-group">
                ...
                <div class="form-group">
					...
					<div class="col-md-6">
						<input type="email" class="form-control" id="config_smtp_port" name="config_smtp_port" value="<?php echo $f_config['config_smtp_port'];?>">
					</div>
				</div>
                <div class="form-group">
					<label for="config_smtp_timeout" class="col-md-3 control-label">SMTP Timeout:</label>
					<div class="col-md-6">
						<input type="email" class="form-control" id="config_smtp_timeout" name="config_smtp_timeout" value="<?php echo $f_config['config_smtp_timeout'];?>">
					</div>
				</div>
                </form>
          	</div>
