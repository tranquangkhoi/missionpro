      ...
      <div id="main" class="container">
      		<div class="row">  			
                <div class="col-md-12">
                    <div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
                        <a class="btn btn-primary" href="javascript:frm_submit('frm_newadd');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
		...
		<div class="panel panel-default">          
			...
			<div class="panel-body">
                <form enctype="multipart/form-data" name="frm_newadd" id="frm_newadd" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/add' method="POST">
				<?php if(!empty($msg)){?>
                            ...
                            <div class="col-md-12">
	                            <div class="form-group">
            		                ...
            		                <div class="form-inline">
                    		        	<input type="text" id="new_date" name="new_date" class="form-control" maxlength="50" value="<?php echo $f_new['new_date'];?>" > (dd/mm/yyyy)
                                    	<input type="text" id="new_time" name="new_time" class="form-control" maxlength="50" value="<?php echo $f_new['new_time'];?>" > (Giờ:phút:giây)
		                            </div>
        	                	</div>
                            </div>
                        </div>                                                                           
