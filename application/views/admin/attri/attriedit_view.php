      ...
      <div id="main" class="container">
        <div class="well_tbl">
            <div class="btn-toolbar pull-right">        	
                <a class="btn btn-primary" href="javascript:frm_submit('frm_attriedit');">Cập nhật <i class="icon-plus icon-white"></i></a>
                  ...
                  <tr>
                    ...
                    <tr>
                      <td style="padding-top:10px;">
                         ...
                         <form enctype="multipart/form-data" name="frm_attriedit" id="frm_attriedit" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $f_attri['attri_id'];?>' method="POST">
                                  ...
                                  <input name="id" type="hidden" id="id" value="<?php echo $f_attri['attri_id'];?>" />                                                                                      
                            </form>                            
