    ...
    <div id="wrap">
      ...
      <div id="main" class="container">
       ...
       <?php 
		...
		?>
       <form id="frm_intros" class="form-horizontal" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/del' method="POST" style="display:inline;">
       
       <div class="row">
        	<div class="col-md-2">            	
            	 <select id="introcate_id" name="introcate_id" class="form-control" style="margin-bottom:10px; margin-top:-10px; width:190px;" onchange="frm_submit_action('frm_intros','<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/filter')">
                      	<?php echo $introcate_choose;?>
                 </select>               
            </div>
  			<div class="col-md-3">            	 
                 <div class="input-group" style="margin-bottom:10px; margin-top:-10px;">
                          ...
                          <span style="cursor:pointer;" class="input-group-addon" onclick="frm_submit_action('frm_intros','<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/filter')" >
       ...
       <div style="clear:both;"></div>
            ...
            <table class="table table-bordered table-hover">
			  ...
			  ?>  
                <tr>
                    <td style="text-align:center;"><input type="checkbox"  class="check_one" name="check_del[]" value="<?php echo $item['intro_id'];?>"></td>
                    <td style="text-align:center;"><?php echo $stt;?></td>
                    <td><?php echo $item['intro_title'];?></td>
                    <td><?php echo $this->back->fix_date('H:i:s A, d/m/Y',$item['intro_time_posted']);?></td>                                       
                    <td style="text-align:center;">
                     <a href="<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $item['intro_id'];?>"><span class="glyphicon glyphicon-pencil"></span></a>                                          
                    </td>
                </tr>
              <?php
			  }
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" onclick="frm_submit('frm_intros')">Xóa</button> 
