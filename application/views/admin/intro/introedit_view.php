    ...
    <div id="wrap">
      ...
      <div id="main" class="container">
            ...
            <div class="row">  			
                <div class="col-md-12">
                    <div class="btn-toolbar pull-right btn-group" style="margin-bottom:10px; margin-top:-10px;">        	
                        <a class="btn btn-primary" href="javascript:frm_submit('frm_introedit');"><span class="glyphicon glyphicon-floppy-disk"></span> Ghi lại</a>
			...
			<div class="panel-body">
                <form enctype="multipart/form-data" name="frm_introedit" id="frm_introedit" action='<?php echo base_url().$this->config->item('index_page_add');?>admin/<?php echo $this->uri->segment(2);?>/edit/<?php echo $f_intro['intro_id'];?>' method="POST">
				<?php if(!empty($msg)){?>
                ...
                <ul id="myTab" class="nav nav-tabs">
                    ...
                    <li><a href="#intro_vn" data-toggle="tab">Tiếng Việt</a> </li>                   
				</ul>
                <div id="myTabContent" class="tab-content">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
            		                ...
            		                <div class="form-inline">
                    		        	<input style="width:120px;" type="text" id="intro_date" name="intro_date" class="form-control" maxlength="50" value="<?php echo $f_intro['intro_date'];?>" > (dd/mm/yyyy)
                                    	<input style="width:120px;" type="text" id="intro_time" name="intro_time" class="form-control" maxlength="50" value="<?php echo $f_intro['intro_time'];?>" > (Giờ:phút:giây)
		                            </div>
        	                	</div>
                        ...
                        <div class="row">                                                    	
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
	                            <div class="form-group">  
                                	<?php
									if($f_intro['image_old']<>''){
									 ?>
                                    <div id="deleteimg" class="control-group">
										<label class="control-label" for="input01">Ảnh cũ</label>
										<div class="controls">
											<img class="img-thumbnail" src="<?php echo base_url();?>/public/upload/intro/<?php echo 'small_'.$f_intro['image_old'];?>" />
                                            <a class="btn btn-danger delete" href="<?php echo base_url().$this->config->item('index_page_add').'admin/'.$this->uri->segment(2);?>/delimg/<?php echo $f_intro['intro_id'];?>">
                    ...
                    <div class="tab-pane fade" id="intro_vn" style="padding-top:20px;">
                        ...
                        <div class="row">
                  		 ...
                  		 <input name="id" type="hidden" id="id" value="<?php echo $f_intro['intro_id'];?>" />
                         <input name="image_old" type="hidden" id="image_old" value="<?php echo $f_intro['image_old'];?>" />                            	
 				</form>               	
          	</div>
		</div>
